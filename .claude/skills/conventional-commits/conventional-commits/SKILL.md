...
- **Hard limit: 50 characters** (including type and scope prefix). Count before proposing.
...
5. **Ensure the body adds value** - when in doubt, omit the body
6. **Include only relevant context** in the body
7. **NEVER add AI attribution** - no tool attribution of any kind
